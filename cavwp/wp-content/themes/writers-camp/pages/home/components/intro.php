...
$guide   = get_post(\get_field('pages_guide', 'option'));
$content = apply_filters('the_content', get_extended($guide->post_content)['main']);
   ...
   <div class="flex-1 flex flex-col justify-between items-start gap-9">
      ...
      <div class="flex gap-4">
         ...
         <button class="btn" type="button"
                 x-on:click.prevent="$store.login.method='intro';login.showModal()">Entrar</button>
         <?php } ?>
      </div>
   </div>
