...
class Register
{
   ...
   public function add_menu_items($items, $args)
   {
      ...
      if (!is_user_logged_in()) {
         $new_items .= '<li class="menu-item menu-item-type-custom"><button class="cursor-pointer" type="button" x-on:click.prevent="$store.login.method=\'intro\';login.showModal()">Cadastre-se</button></li>';
      }
