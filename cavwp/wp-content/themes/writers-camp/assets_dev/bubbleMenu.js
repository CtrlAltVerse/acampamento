...
var BubbleMenuView = class {
   constructor({
      ...
      this.blurHandler = ({ event }) => {
         ...
         if (
            (event == null ? void 0 : event.relatedTarget) &&
            ((_a = this.element.parentNode) == null
               ? void 0
      ...
      this.handleDebouncedUpdate = (view, oldState) => {
         const selectionChanged = !(oldState == null
            ? void 0
            : oldState.selection.eq(view.state.selection))
         const docChanged = !(oldState == null
            ? void 0
   ...
   show() {
      ...
      ;(_a = this.view.dom.parentElement) == null
         ? void 0
         : _a.appendChild(this.element)
